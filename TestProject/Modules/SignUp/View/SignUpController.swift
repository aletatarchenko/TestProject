...
final class SignUpController: BaseViewController<SignUpControllerView, SignUpViewModel> {
  ...
  @objc private func textNameDidChange(_ textField: UITextField) {
  ...
  private func setupUI() {
    ...
    view.nameTestField.addTarget(
      self,
      action: #selector(textNameDidChange(_:)),
      for: .editingChanged
    )
